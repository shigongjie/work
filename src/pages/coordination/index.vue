    ...
    <div class="wrap">
      <el-card class="right-page">
        <div class="main-head">
          ...
          <div class="btns">
            <el-button type="primary" size="small" @click="creatCoop()">创建协同安排</el-button>
          ...
          <el-table-column width="180px" fixed="right" align="center" label="操作">
            <template slot-scope="scope">
              ...
              <el-button
                type="text"
                size="small"
                v-if="scope.row.approveFlag==true"
...
import creatCoop from "./components/createcoop";
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const d = await this.post(this.$api.coop.pageCoop, {
        ...this.params
      });
      if (d.code === 0) {
...
/deep/ .coopDialog .el-dialog__body {
